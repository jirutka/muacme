...
* Issue a certificate for domain _example.org_ with alternative name _www.example.org_ and options specified in the configuration file _/etc/muacme/muacme.conf_:
+
[source, sh]
